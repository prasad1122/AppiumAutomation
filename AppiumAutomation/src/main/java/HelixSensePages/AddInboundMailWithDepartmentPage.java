...
public class AddInboundMailWithDepartmentPage extends HelixsensePageBase {

	String senderInformation="DurgaPrasad,Room:ODC-207";
	...
	public AddInboundMailWithDepartmentPage(AndroidDriver driver) {
		super(driver);
	...
	public void addInbounddetails() throws InterruptedException {
		...
		edittext.get(2).sendKeys("Blue Dart Express Limited");
		...
		edittext.get(3).sendKeys("1234567");
		
		edittext.get(4).sendKeys(senderInformation);
		...
		description.sendKeys("Parcel Deleivered By amazon");
